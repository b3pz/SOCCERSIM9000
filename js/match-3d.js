...
function updateBroadcastHud(){
 ...
 const chEl=broadcastHud.querySelector('.s9-tv-channel');if(chEl){const chTxt=current?.channel||(window.S9Channel?window.S9Channel():'S9 90');if(chEl.dataset.ch!==chTxt){chEl.dataset.ch=chTxt;chEl.innerHTML=`${window.S9ChannelBadge?S9ChannelBadge(chTxt):chTxt} <i>LIVE</i>`}}
...
function installBroadcastLayer(){
 ...
 broadcastHud=document.createElement('div');broadcastHud.className='s9-tv-layer';broadcastHud.innerHTML=`<div class="s9-tv-scorebug"><div class="s9-tv-channel">${(()=>{const n=current?.channel||(window.S9Channel?window.S9Channel():'S9 90');return window.S9ChannelBadge?S9ChannelBadge(n):n})()} <i>LIVE</i></div><div class="s9-tv-clock">1T&nbsp;&nbsp;00'</div><div class="s9-tv-team"><img class="s9-tv-home-crest" alt=""><span class="s9-tv-home-name">CASA</span><b class="s9-tv-home-score">0</b></div><div class="s9-tv-team"><img class="s9-tv-away-crest" alt=""><span class="s9-tv-away-name">OSPITI</span><b class="s9-tv-away-score">0</b></div></div><div class="s9-tv-watermark">SERIEA 9000 SIM</div><div class="s9-tv-event" hidden><b class="s9-tv-event-minute">00'</b><span class="s9-tv-event-text"></span></div><div class="s9-tv-goal" hidden aria-live="polite"><small>GOL</small><strong>MARCATORE</strong><span></span></div><div class="s9-tv-controls" aria-label="Comandi partita"><button type="button" class="s9-tv-pause" aria-label="Metti in pausa la partita">Ⅱ</button><button type="button" class="s9-tv-speed" aria-label="Cambia velocità">1×</button><button type="button" class="s9-tv-tactics" aria-label="Apri tattica e cambi">⚙</button></div><button type="button" class="s9-tv-exit" aria-label="Esci dalla modalità televisiva">✕</button>`;
